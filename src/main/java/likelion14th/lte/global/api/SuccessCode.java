...
public enum SuccessCode implements BaseCode { // 성공
    ...
    FOLLOW_FOLLOWERS_SUCCESS(HttpStatus.OK, "FOLLOW_2004", "팔로워 목록 조회가 완료되었습니다."),
    FOLLOW_FOLLOWINGS_SUCCESS(HttpStatus.OK, "FOLLOW_2005", "팔로잉 목록 조회가 완료되었습니다."),
    FOLLOW_CAN_FOLLOW_SUCCESS(HttpStatus.OK, "FOLLOW_2006", "팔로우 가능 유저 목록 조회가 완료되었습니다."),
